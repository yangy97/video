...
class  Connectsms extends BaseMall {
    ...
    public function find_password() {
        ...
        $login_set_name = trim(input('login_set_name'));
        $member_password = trim(input('member_password'));
     
        // $member_password_check = trim(input('member_password_check'));
        //判断验证码是否正确
        ...
        $condition = array();
        // $condition['login_set_name'] = $login_set_name;
        ...
        $member_model = model('member');
        // die;   // dump( $member_model );
     
        $member = $member_model->getMemberInfo(array('member_name' => $login_set_name)); 
    //    dump($member);
    //    die;
