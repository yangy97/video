...
class  Membersecurity extends BaseMember {
    ...
    public function auth() {
        ...
        if (!request()->isPost()) {
            ...
            $member_info['member_emailbind'] ='1';
            if (!$member_info) {
            ...
            if (($type == 'modify_pwd' && $member_info['member_emailbind'] == '1') || ($type == 'modify_paypwd' && $member_info['member_mobilebind'] == '1')) {
            ...
            case 'modify_pwd':
                $menu_array = array(
                    array(
                        ...
                        'url' => url('Membersecurity/modify_pwd', ['type' => 'modify_pwd'])
                    ),
                );
                return $menu_array;
            //     break;
            ...
            case 'modify_paypwd':
                $menu_array = array(
                    array(
                        ...
                        'url' => url('Membersecurity/modify_paypwd', ['type' => 'modify_paypwd'])
                    ),
                );
                return $menu_array;
                break;
